...
const handlers = {
  ...
  issue: {
    ...
    getCreatorDisplayName: body => getNameFromMail(Ramda.path(['issue', 'fields', 'creator', 'emailAddress'], body)),
...
const utils = {
  ...
  isCommentEvent: body => utils.getHookType(body) === 'comment' && !utils.getBodyWebhookEvent(body).includes('deleted'),
